...
class PatientService {
    private patients: Patient[] = [
        ...
        { id: 2, age: 42, weight: 62, height: 1.57, body: 'Sobrepeso', description: 'Piel morena y cabello negro corto y ondulado. Rostro ancho con pómulos hinchados. Labios muy carnosos, con cortaduras en ellos, cejas ligeramente gruesas y ojos en forma de almendra, de un color...', institutionId: 2 },
        { id: 3, age: 20, weight: 72, height: 1.83, body: 'Atlético', description: 'Piel morena clara y el cabello negro, corto y con orientación hacia la izquierda. Tiene una mandíbula definida, complexión delgada pero atlética. Tiene heridas en la zona de la frente y el ojo...', institutionId: 3 }
    ];
